...
export const WhatsAppButton = () => {
    ...
    return (
        <motion.a
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[var(--brand-primary)] rounded-full shadow-lg hover:bg-[var(--brand-secondary)] transition-colors duration-300 md:bottom-8 md:right-8"
